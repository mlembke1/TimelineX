...
require('../../../node_modules/timelinex/dist/timelinex/styles.css');
...
export default class TimelinexWebPart extends BaseClientSideWebPart<ITimelinexWebPartProps> {
  ...
  public render(): void {
    this.domElement.innerHTML = `<app-timelinex-web-part description="${ this.properties.description }"></app-timelinex-web-part>`;
  }
